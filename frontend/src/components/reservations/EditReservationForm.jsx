...
const EditReservationForm = ({ reservation, onClose, onSubmit }) => {
  ...
  const [priority, setPriority] = useState(reservation.priority || "medium")
  ...
  }, [formData.requestedAmount, pricePerLiter, reservation.totalPrice])
