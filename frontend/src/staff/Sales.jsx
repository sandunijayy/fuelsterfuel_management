...
function Sales() {
  ...
  const { transactions, fetchTransactions, isLoading, error, addTransaction, updateTransaction, deleteTransaction } = salesAuth();
  ...
  const handleUpdateTransaction = async (e) => {
    ...
    try {
      await updateTransaction(currentTransactionId, name, fuelType, quantity, price, paymentMethod);
  ...
  return (
    <div className="ml-64 p-10 bg-gray-100">
      <h2 className="text-4xl font-semibold text-gray-700 mb-16 text-center">Sales Transactions</h2>
        ...
        <tbody>
          {isLoading ? (
            ...
            transactions.map((transaction) => (
              <tr key={transaction._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      {showModal && (
        <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-xl border border-gray-300">
            <h2 className="text-2xl font-semibold text-gray-700 text-center mb-4">{isEdit ? "Update Transaction" : "Add New Transaction"}</h2>
            <form className="flex flex-col space-y-4" onSubmit={isEdit ? handleUpdateTransaction : handleAddTransaction}>
              ...
              <div className="flex justify-between">
                <button type="submit" className="w-1/2 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700">
                  {isEdit ? "Update" : "Add"}
                </button>
                <button
